...
<p class="alert alert-success">${mess_1}</p>
<div style="">
    ...
    <div>
        <form class="row g-3" method="post" >
            <div class="col-12">
                ...
                <input name="name" value="${electronic.name}" type="text" class="form-control" id="inputName" placeholder="name">
            </div>
            <div class="col-12">
                <label for="inputImage" class="form-label">Ảnh</label>
                <input name="image"value="${electronic.image}"  type="text" class="form-control" id="inputImage" placeholder="image">
            </div>
            <div class="col-12">
                <label for="inputPrice" class="form-label">Giá sản phẩm</label>
                <input name="price" value="${electronic.price}"  type="text" class="form-control" id="inputPrice" placeholder="Nhập giá">
            </div>
            <div class="col-md-12">
