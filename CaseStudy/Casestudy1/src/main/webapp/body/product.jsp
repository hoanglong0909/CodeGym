    ...
    <div id="top-header">
        <div class="container">
            <ul class="header-links pull-left">
                <li><a href="#"><i class="fa fa-phone"></i> + 0935 374 666</a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i> long113@email.com</a></li>
                <li><a href="#"><i class="fa fa-map-marker"></i> 123 Nguyễn Tất thành</a></li>
            </ul>
                ...
                <div class="col-md-6">
                    <div class="header-search">
                        <form action="search" method="post">
                            ...
                            <input class="input" name="searchList" value="${searchs}"  placeholder="Search here">
                                ...
                                <div class="cart-list">
                                    <div class="product-widget">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name"><a href="#">${detail.name}</a></h3>
                                            <h4 class="product-price"><span class="qty">1x</span>${detail.price}</h4>
                                        </div>
                                    ...
                                    <div class="product-widget">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name"><a href="#">${detail.name}</a></h3>
                                            <h4 class="product-price"><span class="qty">3x</span>${detail.price}</h4>
                                        </div>
                                        <button class="delete"><i class="fa fa-close"></i></button>
                                    </div>
                                </div>
    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                <li class="active"><a href="electronics">Home</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div>
                        <h3 class="product-price">${detail.price}
                            <del class="product-old-price">$990.00</del>
                        </h3>
                        <span class="product-available">In Stock</span>
                    </div>
                    <p>HP Notebook 11 là dòng máy giá rẻ, gọn nhẹ, hướng đến phân khúc bình dân của HP. Máy có thiết kế
                        nguyên khối, không thể tháo rời pin, không trang bị quạt cũng như ổ đĩa giúp máy mỏng và nhẹ tối
                        đa. .</p>
                ...
                <div id="product-tab">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab2" class="tab-pane fade in">
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Các ứng dụng công nghệ thông tin đã góp phần làm cho đời sống của con người trở nên tiện nghi và dễ dàng hơn. Những mặt lợi ích mà công nghệ thông tin đem lại rất lớn, giúp các lĩnh vực trong đời sống xã hội ngày càng phát triển và xây dựng một xã hội văn minh hơn..</p>
                                </div>
                            </div>
                        </div>
                        <!-- /tab2  -->
