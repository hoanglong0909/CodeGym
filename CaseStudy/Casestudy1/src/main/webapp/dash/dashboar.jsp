    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
            <button class="navbar-toggler navbar-toggler align-self-center" type="button">
                <span> <a href="/electronics">Trang chủ</a></span>
            </button>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                        ...
                        <a class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                <h6 class="preview-subject font-weight-medium">Cài đặt</h6>
                                <p class="font-weight-light small-text">
                                    Tin nhắn riêng
                                </p>
                            </div>
                        ...
                        <a class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                <h6 class="preview-subject font-weight-medium">Đăng Ký Người Dùng Mới</h6>
                                <p class="font-weight-light small-text">
                                    2 days ago
                                </p>
                            </div>
                            ...
                            <ul class="d-flex flex-column-reverse todo-list">
                                ...
                                <li>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="checkbox" type="checkbox">
                                            Giải quyết tất cả các vé ưu tiên thấp do hôm nay
                                        </label>
                                    </div>
                                    <i class="remove mdi mdi-close-circle-outline"></i>
                                </li>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="pages\samples\login.html"> Đăng nhập </a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="pages\samples\login-2.html"> Đăng nhập 2 </a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="pages\samples\register.html">
                                    Đăng ký </a></li>
                                <li class="nav-item"><a class="nav-link" href="pages\samples\register-2.html"> Đăng ký
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages\apps\calendar.html">
                            ...
                            <span class="menu-title">Lịch</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages\apps\todo.html">
                            <i class="icon-clock menu-icon"></i>
                            <span class="menu-title">Những việc cần làm</span>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-md-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="mb-0">Nhiệm vụ hoàn thành</p>
                                        <h6>2346</h6>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex flex-column">
                        <div class="row flex-grow">
                            <div class="col-12 col-md-4 col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="card-title">sự phát triển</h6>
                                        <div class="row">
                                        ...
                                        <div class="d-flex flex-column align-items-center mt-3">
                                            <div id="growth-chart">
                                                7, 10, 11, 9, 11, 16, 12, 15, 13, 8, 12, 10, 13, 10, 16, 15, 12, 8, 10,
                                                7, 16, 12, 8, 9, 7, 12
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-title">Bán hàng hàng ngày</h6>
                                <div class="w-75 mx-auto">
                                    <div class="d-flex justify-content-between text-center">
                                        <div class="wrapper">
                                            <h4>$2256</h4>
                                            <small class="text-muted">Bán hàng totel</small>
                                        </div>
                                        <div class="wrapper">
                                            <h4>584</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="w-75 mx-auto">
                                    <div class="d-flex justify-content-between text-center mt-5">
                                        <div class="wrapper">
                                            <h4>5136</h4>
                                            <small class="text-muted">Bán hàng trực tuyến</small>
                                        </div>
                                        <div class="wrapper">
                                            <h4>4596</h4>
                                            <small class="text-muted">Cửa hàng bán hàng</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row grid-margin">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-title">Tình trạng đặt hàng</h6>
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description">Products that are creating the most revenue and their sales
                                        ...
                                        <div class="wrapper border-bottom py-2">
                                            <div class="d-flex">
                                                ...
                                                <div class="wrapper ml-4">
                                                    ...
                                                    <small class="text-muted mb-0">Not satisfied with the
                                                        service.</small>
                                                </div>
                                                <div class="rating ml-auto d-flex align-items-center">
