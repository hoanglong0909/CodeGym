    ...
    <div id="top-header">
        <div class="container">
            ...
            <ul class="header-links pull-right">
                ...
                <li><a href="body/home.jsp"><i class="fa fa-user-o"></i>Tài khoản của tôi</a></li>
            </ul>
        </div>
    </div>
    <!-- /TOP HEADER -->
                ...
                <div class="section-title">
                    ...
                    <div class="section-nav">
                        <ul class="section-tab-nav tab-nav">
                            ...
                            <c:forEach items="${categoryList}" var="category">
                                <li class="section-tab-nav tab-nav ${tag == category.id ? "active":""}"><a href="category?id=${category.id}">${category.name}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
                </div>
                                ...
                                <c:forEach items="${electronicList}" var="electronic">
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-name"><a href="detail?pid=${electronic.id}">${electronic.name}</a></h3>
                                            ...
                                            <div class="product-btns">
                                                ...
                                                <button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp">xem lướt qua</span>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="products-slick" data-nav="#slick-nav-2">
                                    ...
                                    <c:forEach items="${electronicList}" var="electronic">
                                        <div class="product">
                                            ...
                                            <div class="product-body">
                                                <p class="product-category">thể loại</p>
                                                <h3 class="product-name"><a href="#">${electronic.name}</a></h3>
                                                <h4 class="product-price">${electronic.price}
                                                    <del class="product-old-price">${electronic.price}</del>
                                                </h4>
                                                <div class="product-rating">
