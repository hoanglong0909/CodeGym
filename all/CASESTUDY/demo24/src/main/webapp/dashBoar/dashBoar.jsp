...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="dashBoar\vendors\mdi\css\materialdesignicons.min.css">
  <link rel="stylesheet" href="dashBoar\vendors\simple-line-icons\css\simple-line-icons.css">
  <link rel="stylesheet" href="dashBoar\vendors\flag-icon-css\css\flag-icon.min.css">
  <link rel="stylesheet" href="dashBoar\vendors\css\vendor.bundle.base.css">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <link rel="stylesheet" href="dashBoar\vendors\font-awesome\css\font-awesome.min.css">
  <link rel="stylesheet" href="dashBoar\vendors\jquery-bar-rating\fontawesome-stars.css">
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="dashBoar\css\style.css">
  <!-- endinject -->
  <link rel="shortcut icon" href="dashBoar\images\favicon.png">
</head>
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="dashBoar.jsp"><img src="images\logo.svg" alt="logo"></a>
        <a class="navbar-brand brand-logo-mini" href="dashBoar.jsp"><img src="images\logo-mini.svg" alt="logo"></a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <div class="nav-link">
                <div class="profile-image">
                  <img src="images/long.jpg" alt="image">
            ...
            <li class="nav-item">
              <a class="nav-link" href="dashBoar.jsp">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="editors">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="pages\forms\text_editor.html">Text editors</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages\tables\basic-table.html">Basic table</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages\tables\data-table.html">Data table</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages\tables\js-grid.html">Js-grid</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages\tables\sortable-table.html">Sortable table</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages\ui-features\notifications.html">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="icons">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="pages\icons\themify.html">Themify icons</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="pages\samples\timeline.html"> Timeline </a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages\apps\todo.html">
